...
object Game {
    ...
    fun sellLoot() {
        when (val currentRoom = currentRoom) {
            is TownSquare -> {
                ...
                narrate("You cannot sell anything here")
            }
        }
    }
    ...
    private class GameInput(arg: String?) {
        ...
        fun processCommand() = when (command.lowercase()) {
            ...
            "take" -> {
                if (argument.equals("loot", ignoreCase = true)) takeLoot()
                else narrate("I don't know what you're trying to take")
            }

            "sell" -> {
                if (argument.equals("loot", ignoreCase = true)) sellLoot()
